...
pub use install::{
    InstallError, InstalledPackage, RecoveryReport, UninstallError, UninstallReport, install_dir,
    install_package, install_trusted_package, recover_trusted_installs, uninstall_package,
