...
| 透明、无边框、置顶窗口 | 🧪 | 已接入 winit 属性；Windows 已有 `WS_EX_TOPMOST`/分层实测证据，macOS/X11/Wayland 待实测 |
...
| 平台 | 目标 | 当前证据 |
|---|---|---|
| Windows | 透明、置顶、点击穿透、编辑/展示模式 | 透明/置顶/点击穿透 API 已有实测（2026-08-13，DWM）；编辑/展示模式待接入 |
